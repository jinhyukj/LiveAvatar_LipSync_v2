...
video_folder_path = "/mnt/dataset1/jinhyuk/AIPark_processed/videos_cfr"
...
audio_folder_path = "/mnt/dataset1/jinhyuk/AIPark_processed/audio_emb"

# Where to save the final metadata.csv file
output_csv_path = "./metadata_AIPark.csv"
